...
class TwitterHook(HttpHook):
    ...
    def create_url(self):
        tweet_fields = \
            ...
            "in_reply_to_user_id,public_metrics,text"
        user_fields = "expansions=author_id&user.fields=id,name,username,created_at"
        filters = "start_time=2022-02-20T00:00:00.00Z&end_time=2022-02-22T00:00:00.00Z"
        ...
        end_time = (
            f'&start_time={self.end_time}'
            if self.end_time
            else ''
        )
        url = "{}/2/tweets/search/recent?query={}&{}&{}{}{}".format(
            self.base_url, self.query, tweet_fields, user_fields, start_time, end_time
        )
        return url
...
if __name__ == '__main__':
    for pg in TwitterHook("@FortalezaEC").run():
